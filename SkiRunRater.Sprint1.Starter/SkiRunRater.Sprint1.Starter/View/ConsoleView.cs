    ...
    public static class ConsoleView
    {
        ...
        public static AppEnum.ManagerAction GetUserActionChoice()
        {
            ...
            Console.WriteLine(
                ...
                leftTab + "2. Delete the Ski Run with ID" + Environment.NewLine +
                leftTab + "3. Update the Ski Run with ID" + Environment.NewLine +
                leftTab + "4. Add a Ski Run" + Environment.NewLine +
                leftTab + "5. Display a Ski Run Detail with ID" + Environment.NewLine +
